...
from deepSORT.CNN.CNNDeepSort import CNNDeepSORT  # Importing model
from deepSORT.CNN.cnn_data_preparation import load_annotations, TrackingDataset, collate_fn  # Import dataset functions

#Define file paths
video_path = r"/deepSORT/train/MOT17-02/img1"
ini_file = r"/deepSORT/train/MOT17-02/seqinfo.ini"
